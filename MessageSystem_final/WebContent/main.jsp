...
<body>
	...
	<div id="wrapper">
		...
		<%if(info != null) {%> <%if(info.getEmail().equals("admin")) {%> <a
			href="select.jsp">회원정보관리</a> <%}%> <a href="update.jsp">개인정보수정</a> <a
			href="LogoutServiceCon">로그아웃</a> <%}else{ %> <a href="#menu">로그인</a> <%} %>
